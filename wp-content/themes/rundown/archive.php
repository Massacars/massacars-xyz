			...
			<div id="content">
				...
				<?php if (have_posts()) : ?>
					...
					<h2 class="archive-title">
						...
						<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly Archives: %s', 'rundown' ), '<span>' . get_the_date( __( 'F Y', 'rundown' ) ) . '</span>' ); ?>
						<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly Archives: %s', 'rundown' ), '<span>' . get_the_date( __( 'Y', 'rundown' ) ) . '</span>' ); ?>
